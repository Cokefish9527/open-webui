...
项目提供了 PowerShell 脚本自动设置 Python 3.11.9 虚拟环境并启动服务：

```powershell
# 在项目根目录运行（需要 PowerShell）
.\setup_and_start_python311.ps1
```

该脚本会自动：
1. 检查系统中是否安装了 Python 3.11
2. 创建或使用现有的虚拟环境
3. 安装所有依赖
4. 启动 Open-WebUI 服务
...
详细说明请参考 [计费系统文档](./docs/计费系统/README.md)
...
### 计费系统
- [计费系统/README.md](./docs/计费系统/README.md) - HSAI计费系统的详细说明文档
- [计费系统API接口文档.md](./docs/计费系统/计费系统API接口文档.md) - 计费系统API接口详细说明
- [HSAI项目计费方案.md](./docs/HSAI项目计费方案.md) - 计费系统设计方案
