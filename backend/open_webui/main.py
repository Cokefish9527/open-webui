...
from open_webui.routers import (
    ...
    # hsai_materials_categories,  # 素材分类设计已作废（2025-12-28），不再对外暴露该路由
...
app.state.config.DEFAULT_CUSTOMER_ROLE = DEFAULT_CUSTOMER_ROLE
app.state.config.CUSTOMER_PERMISSION_TEMPLATE = CUSTOMER_PERMISSION_TEMPLATE
...
app.state.config.ENABLE_CUSTOMER_PERMISSION_API = ENABLE_CUSTOMER_PERMISSION_API
...
# app.include_router(hsai_materials_categories.router, prefix="/api/v1")  # 素材分类设计已作废（2025-12-28）
