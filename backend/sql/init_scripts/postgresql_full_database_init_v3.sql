-- 完整数据库初始化脚本 (PostgreSQL版本) - 分步执行版本
-- 创建时间: 2025-10-04
-- 包含 41 个表和 0 个视图
...
ALTER TABLE "user" ADD CONSTRAINT fk_user_company_id FOREIGN KEY (company_id) REFERENCES companies(id) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE hsai_projects ADD CONSTRAINT fk_hsai_projects_company_id FOREIGN KEY (company_id) REFERENCES companies(id) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE hsai_materials ADD CONSTRAINT fk_hsai_materials_folder_id FOREIGN KEY (folder_id) REFERENCES hsai_material_folders(id) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE hsai_platform_accounts ADD CONSTRAINT fk_hsai_platform_accounts_group_id FOREIGN KEY (group_id) REFERENCES hsai_account_groups(id) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE hsai_publish_records ADD CONSTRAINT fk_hsai_publish_records_platform_account_id FOREIGN KEY (platform_account_id) REFERENCES hsai_platform_accounts(id) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE hsai_publish_records ADD CONSTRAINT fk_hsai_publish_records_publish_task_id FOREIGN KEY (publish_task_id) REFERENCES hsai_publish_tasks(id) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE hsai_cards ADD CONSTRAINT fk_hsai_cards_task_id FOREIGN KEY (task_id) REFERENCES hsai_tasks(id) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE hsai_workflow_executions ADD CONSTRAINT fk_hsai_workflow_executions_trigger_task_id FOREIGN KEY (trigger_task_id) REFERENCES hsai_tasks(id) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE hsai_workflow_executions ADD CONSTRAINT fk_hsai_workflow_executions_workflow_id FOREIGN KEY (workflow_id) REFERENCES hsai_workflows(id) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE hsai_tasks ADD CONSTRAINT fk_hsai_tasks_workflow_id FOREIGN KEY (workflow_id) REFERENCES hsai_workflows(id) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE hsai_tasks ADD CONSTRAINT fk_hsai_tasks_parent_task_id FOREIGN KEY (parent_task_id) REFERENCES hsai_tasks(id) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE hsai_tasks ADD CONSTRAINT fk_hsai_tasks_project_id FOREIGN KEY (project_id) REFERENCES hsai_projects(id) ON DELETE NO ACTION ON UPDATE NO ACTION;