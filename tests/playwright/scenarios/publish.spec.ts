...
test.describe("S4-PUBLISH", () => {
  test("账号授权与多平台发布", async ({ page, contextState, accountPool }: { page: Page; contextState: ScenarioContext; accountPool: string[] }) => {
    ...
    // 截图：账号授权
    await screenshotHelper.takeScenarioScreenshot(page, "S4-PUBLISH", "02", "account-authorization");
