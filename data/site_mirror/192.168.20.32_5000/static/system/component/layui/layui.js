/** v2.9.10 | MIT Licensed */ !(function (d) {
	'use strict';
	var t,
		h = d.document,
	...
	(Array.prototype.indexOf =
			...
			if (n)
				return (
					'styleSheet' in e
						...
						: (e.innerHTML = n),
					(e.id = 'LAY-STYLE-' + (t.id || ((n = d.style.index || 0), d.style.index++, 'DF-' + n))),
		...
		(d.position = function (t, e, n) {
			...
			e &&
				...
				'center' === n.align
					? (u -= (s - t.offsetWidth) / 2)
					: 'right' === n.align && (u = u - s + t.offsetWidth),
				(u = u + s + c > r('width') ? r('width') - s - c : u) < c && (u = c),
				i.bottom + f + c > r() &&
					(i.top > f + c && i.top <= r()
						? (a = i.top - f - 2 * c)
						: n.allowBottomOut || ((a = r() - f - 2 * c) < 0 && (a = 0))),
		...
		(d.touchSwipe = function (t, e) {
			...
			c &&
				...
				(e = function (t) {
					1 === t.touches.length &&
						(c.addEventListener('touchmove', i, !!d.passiveSupported && { passive: !1 }),
				...
				(o = function (t) {
					r.onTouchEnd && r.onTouchEnd(t, n),
						...
						c.removeEventListener('touchend', o, !!d.passiveSupported && { passive: !1 }),
				...
				var i,
					...
					l = {
						...
						page: (function () {
							...
							for (
								i - t < r - 1 && (t = i - r + 1),
									!1 !== n.first && 2 < t && e.push('<span class="layui-laypage-spr">...</span>');
								t <= i;
								t++
							)
								t === n.curr
	...
	(s.formatArr = function (e) {
		...
		(k.prototype.limit = function (t) {
			...
			return (
				...
				t.elem && t.elem[a ? 'addClass' : 'removeClass'](M),
				a
			);
		}),
		...
		(k.prototype.calendar = function (e, i, t) {
			...
			return (
				...
				lay.each(u, function (e, t) {
					...
					(t = lay(t)).removeAttr('class'),
						e < l
							...
							: l <= e && e < o + l
								? ((a = e - l), d.rangeLinked || (a + 1 === s.date && t.addClass(C)))
								: ((a = e - o - l),
				...
				a.range ||
					...
					d.limit({ elem: lay(d.footer).find(L), index: 0, time: u, disabledType: 'datetime' })),
				d.setBtnStatus(),
				lay(d.shortcut)
					.find('li.' + C)
					.removeClass(C),
			...
			var l,
				...
				h = lay.elem('ul', {
					class:
						b +
						' ' +
						{ year: 'laydate-year-list', month: 'laydate-month-list', time: 'laydate-time-list' }[n]
				}),
				p = s.elemHeader[i],
				f = lay(p[2]).find('span'),
				g = s.elemCont[i || 0],
										...
										lay(e)
											...
											.each(function (e, t) {
												s.limit({
													...
													rangeType: i,
													disabledType: 'time',
													time: [['hours'], ['hours', 'minutes'], ['hours', 'minutes', 'seconds']][
														a
													]
												});
											});
		...
		(k.prototype.stampRange = function () {
			...
			l.range && !i.endState && lay(i.footer).find(L).addClass(M),
				...
				lay.each(e, function (e, t) {
					...
					l.rangeLinked &&
						...
						lay(t).removeClass(o + ' ' + C),
						(a !== r && a !== n) ||
							((i.rangeLinked || (!i.rangeLinked && (e < 42 ? a === r : a === n))) &&
								lay(t).addClass(lay(t).hasClass(y) || lay(t).hasClass(m) ? o : C)),
			...
			n(D)
				...
				.on('keydown', function (e) {
					...
					T.thisId &&
						...
						(e.preventDefault(), n(t.footer).find(L)[0].click());
				}),
				...
				return (
					...
					q(function (e, t, n, r) {
						...
						if (e) {
							...
							(d = me(d === t ? d.splice(l, d.length) : d)), y ? y(null, t, d, r) : D.apply(t, d);
					})
				);
			}
			return (
...
!(function (p, h) {
	...
	var m,
				...
				v.path &&
					...
					!(function c(e) {
						...
						return 100 < ++l
							...
							: void (1989 === parseInt(d.getStyle(t, 'width'))
		...
		v = {
			...
			config: function (e, t) {
				return (
					(v.cache = d.config = m.extend({}, d.config, (e = e || {}))),
					(v.path = d.config.path || v.path),
					'string' == typeof e.extend && (e.extend = [e.extend]),
					d.config.path && v.ready(),
			...
			alert: function (e, t, i) {
				...
				return v.open(m.extend({ content: e, yes: (i = n ? t : i) }, n ? {} : t));
			},
			confirm: function (e, t, i, n) {
				var a = 'function' == typeof t;
				return (
					a && ((n = i), (i = t)),
					v.open(m.extend({ content: e, btn: d.btn, yes: i, btn2: n }, a ? {} : t))
				);
			},
			msg: function (e, t, i) {
				var n = 'function' == typeof t,
					...
					v.open(
						m.extend(
							...
							n && !d.config.skin
								...
								: ((-1 !== (t = t || {}).icon && (t.icon !== h || d.config.skin)) ||
		...
		t = function (e) {
			...
			(t.index = ++v.index),
				(t.config.maxWidth = m(g).width() - 30),
		...
		i =
			...
			(t.pt.vessel = function (e, t) {
				...
				return (
					...
					t(
								...
								a.closeBtn &&
									n.push(
										'<span class="layui-icon layui-icon-close ' +
											[u[7], u[7] + (a.title ? a.closeBtn : 4 == a.type ? '1' : '2')].join(' ') +
											'"></span>'
									),
								n.join('')) +
								'</div>' +
						...
						s,
						m('<div class="' + u.MOVE + '" id="' + u.MOVE + '"></div>')
					),
					this
				);
			}),
			(t.pt.creat = function () {
				...
				if (o.id && m('.' + u[0]).find('#' + o.id)[0])
					(e = m('#' + o.id).closest('.' + u[0])),
						(t = e.attr('times')),
						(i = e.data('config')),
						(n = m('#' + u.SHADE + t)),
					...
					switch (
						(o.removeFocus && document.activeElement.blur(),
					...
					a
									...
									? 2 == o.type || 4 == o.type
										...
										: f.parents('.' + u[0])[0] ||
											...
											m('#' + u[0] + s)
												...
												.before(t))
									: l.append(e[1]),
								m('#' + u.MOVE)[0] || l.append((d.moveElem = i)),
								(a.layero = m('#' + u[0] + s)),
								(a.shadeo = m('#' + u.SHADE + s)),
								o.scrollbar || d.setScrollbar(s);
						})
						.auto(s),
						a.shadeo.css({
						...
						2 == o.type && 6 == v.ie && a.layero.find('iframe').attr('src', f[0]),
						4 == o.type
							? a.tips()
							: (a.offset(),
								parseInt(d.getStyle(document.getElementById(u.MOVE), 'z-index')) ||
									(a.layero.css('visibility', 'hidden'),
									v.ready(function () {
										a.offset(), a.layero.css('visibility', 'visible');
									}))),
						!o.fixed ||
							d.events.resize[a.index] ||
							((d.events.resize[a.index] = function () {
								a.resize();
							}),
							g.on('resize', d.events.resize[a.index])),
						o.time <= 0 ||
							setTimeout(function () {
								v.close(a.index);
							}, o.time),
					...
					d.docEvent ||
						(e
							.on('mousemove', function (e) {
								var t, i, n, a, o, s, r;
								d.eventMoveElem &&
									((t = (a = d.eventMoveElem.data(l[0]) || {}).layero),
									(o = a.config),
									...
									t.css({ left: s, top: r })),
									d.eventResizeElem &&
										((o = (a = d.eventResizeElem.data(l[1]) || {}).config),
										(s = e.clientX - a.offset[0]),
										(r = e.clientY - a.offset[1]),
										e.preventDefault(),
							...
							.on('mouseup', function (e) {
								var t, i;
								d.eventMoveElem &&
									((i = (t = d.eventMoveElem.data(l[0]) || {}).config),
									d.eventMoveElem.removeData(l[0]),
									delete d.eventMoveElem,
									d.moveElem.hide(),
									i.moveEnd) &&
									i.moveEnd(t.layero),
									d.eventResizeElem &&
										(d.eventResizeElem.removeData(l[1]),
				...
				t.openLayer(),
					...
					i.find('.layui-layer-max').on('click', function () {
						m(this).hasClass('layui-layer-maxmin')
							? (v.restore(t.index), n.restore && n.restore(i, t.index, t))
							: (v.full(t.index, n),
								setTimeout(function () {
			...
			(d.reselect = function () {
				m.each(m('select'), function (e, t) {
					var i = m(this);
					i.parents('.' + u[0])[0] ||
						(1 == i.attr('layer') && m('.' + u[0]).length < 1 && i.removeAttr('layer').show());
				});
			}),
			(t.pt.IE6 = function (e) {
			...
			(d.record = function (e) {
				...
				var t = e.attr('type'),
					...
					n = [
						e[0].style.width || d.getStyle(e[0], 'width'),
						e[0].style.height || d.getStyle(e[0], 'height'),
						e.position().top,
			...
			(v.min = function (e, t) {
				...
				'min' !== c &&
					...
					(o = (a = 'string' == typeof (o = l.attr('minLeft'))) ? o : 181 * d.minStackIndex + 'px'),
					(s = l.css('position')),
					(r = { width: 180, height: n, position: 'fixed', overflow: 'hidden' }),
					d.record(l),
					0 < d.minStackArr.length && ((o = d.minStackArr[0]), d.minStackArr.shift()),
					parseFloat(o) + 180 > g.width() &&
						(o =
							g.width() -
							180 -
							((d.minStackArr.edgeIndex = d.minStackArr.edgeIndex || 0),
							(d.minStackArr.edgeIndex += 3))) < 0 &&
						(o = 0),
					t.minStack &&
						((r.left = o), (r.top = g.height() - n), a || d.minStackIndex++, l.attr('minLeft', o)),
					l.attr('position', s),
					v.style(e, r, !0),
					i.hide(),
			...
			(v.restore = function (e) {
				...
				t.removeData('maxminStatus'),
					...
					s.scrollbar ? d.restScrollbar(e) : d.setScrollbar(e),
					r !== h &&
						(n.removeData(l), (o === d.type[2] ? n.children('iframe') : n).css({ height: r })),
					i.show();
			}),
			(v.full = function (t) {
				var i = m('#' + u[0] + t),
				...
				l[0] &&
					...
					(e = function () {
						...
						'function' == typeof d.end[o] && d.end[o](),
							...
							'function' == typeof s && s(),
							d.events.resize[o] &&
								(g.off('resize', d.events.resize[o]), delete d.events.resize[o]);
					}),
					(t = m('#' + u.SHADE + o)),
					...
					i.isOutAnim && l.addClass('layer-anim ' + r),
					6 == v.ie && d.reselect(),
					d.restScrollbar(o),
					'string' == typeof l.attr('minLeft') &&
						(d.minStackIndex--, d.minStackArr.push(l.attr('minLeft'))),
					(v.ie && v.ie < 10) || !i.isOutAnim
						? e()
						: setTimeout(function () {
								e();
		...
		(v.photos = function (n, e, a) {
			...
			if ((n = m.extend(!0, { toolbar: !0, footer: !0 }, n)).photos) {
					...
					if (
						(e ||
							c.on('click', n.img, function () {
								...
								v.photos(
									m.extend(n, { photos: { start: e, data: o, tab: n.tab }, full: n.full }),
									!0
								);
							}),
						!e)
				...
				(s.imgprev = function (e) {
					...
					(s.loadi = v.load(1, { shade: !('shade' in n) && [0.9, h, 'unset'], scrollbar: !1 }));
				var t = o[r].src,
					d = function (e) {
						v.close(s.loadi);
						var t,
			...
			fixbar: function (i) {
				var o,
					...
					c =
						((i = s.extend(
							!0,
							{ target: 'body', bars: [], default: !0, margin: 160, duration: 320 },
							i
						)),
						s(i.target)),
...
layui.define(['jquery', 'laytpl', 'lay', 'util'], function (e) {
	...
	(E.prototype.config = {
		...
		(E.prototype.init = function (e, i) {
			...
			return 1 < a.length
				...
				: (c.extend(l, lay.options(a[0])),
					!e && a[0] && a.data(y)
						? (t = g.getThis(a.data(y)))
							? t.reload(l, i)
							: void 0
						: ((l.elem = c(l.elem)),
							(l.id = 'id' in l ? l.id : a.attr('id') || n.index),
							lay.isTopElem(a[0]) || a.attr(f, l.id),
							(l.customName = c.extend({}, h.config.customName, l.customName)),
							(l.show ||
								('reloadData' === i && n.elemView && c('body').find(n.elemView.get(0)).length)) &&
								n.render(e, i),
							void n.events()));
		}),
		(E.prototype.render = function (e, i) {
			var a = this,
				...
				n = function () {
					...
					return (
						0 < d.data.length
							? u(e, d.data)
							: e.html('<li class="layui-menu-item-none">\u6682\u65e0\u6570\u636e</li>'),
						e
					);
				},
				u = function (r, e) {
						...
						layui.each(e, function (e, i) {
							var t,
								...
								a =
									...
									(a = i.templet || d.templet),
									(o = a ? ('function' == typeof a ? a(i) : m(a).render(i)) : o)),
								o =
							...
							('-' === o || i[s.title] || i[s.id] || n) &&
								...
								n &&
									...
									(t = c('<ul></ul>')),
									'parent' === o
										? (l.append(u(t, i[s.children])), a.append(l))
										: a.append(u(t, i[s.children]))),
								r.append(a));
						}),
						r
					);
			...
			(!(e = 'contextmenu' !== d.trigger && !lay.isTopElem(d.elem[0]) ? e : !0) &&
				d.elem.data(y + '_opened')) ||
				((a.elemView = c('.' + v + '[' + f + '="' + d.id + '"]')),
				'reloadData' === i && a.elemView.length
				...
				a.elemView.find('.layui-menu li').on('click', function (e) {
					...
					t.disabled ||
						(n && !l) ||
						'-' === t.type ||
						(!1 === ('function' == typeof d.click ? d.click(t, i) : null) || n || a.remove(),
						layui.stope(e));
				}),
		...
		(E.prototype.remove = function () {
			...
			n &&
				((i = n.attr(f)),
				(e = n.data('prevElem')),
				(t = (i = g.getThis(i)).config.close),
				e && e.data(y + '_opened', !1),
				n.remove(),
				delete g.prevElem,
				'function' == typeof t) &&
				t.call(i.config, e),
		...
		(g.getThis = function (e) {
			var i = g.that[e];
			return (
				i || l.error(e ? r + " instance with ID '" + e + "' not found" : 'ID argument required'), i
			);
		}),
		(g.spread = function (e, i) {
			...
			t.is(':animated') ||
				(n
					? (e.removeClass(a).addClass(d), t.hide().stop().slideDown(200, l))
					: (t.stop().slideUp(200, l), e.removeClass(d).addClass(a)),
				n &&
					i &&
					((t = e.siblings('.' + d)).children('ul').stop().slideUp(200, l),
					t.removeClass(d).addClass(a)));
		}),
		(n = c(window)),
		(i = c(document)),
...
layui.define(['jquery', 'lay'], function (e) {
	...
	(d.prototype.config = {
							...
							i.color
								? ((o = i.color),
									3 < (i.color.match(/[0-9]{1,3}/g) || []).length &&
										((i.alpha && 'rgb' == i.format) || (o = '#' + j(Y(F(i.color))))),
									'background: ' + o)
								: o) +
							'">',
		...
		(d.prototype.renderPicker = function () {
			...
			k(a)[0] && k(a).data('index') == e.index
				? e.removePicker(d.thisElemInd)
				: (e.removePicker(d.thisElemInd), k('body').append(r)),
				(n.thisId = i.id),
		...
		(d.prototype.side = function () {
			...
			e.on('mousedown', function (e) {
				...
				d.on('mousedown', function (e) {
					var i = e.clientY - k(this).offset().top + H.scrollTop(),
						o = e.clientX - k(this).offset().left + H.scrollLeft(),
						o =
				...
				r.touchEventsSupported() &&
					layui.each(
						[
							{ elem: s, eventType: 'click' },
							{ elem: u, eventType: 'click' },
		...
		(d.prototype.select = function (e, i, o, t) {
			this.config;
			var r = j({ h: e, s: 100, b: 100 }),
				e = (j({ h: e, s: i, b: o }), (e / 360) * 180),
				o = 180 - (o / 100) * 180,
				i = (i / 100) * 260,
				n = this.elemPicker.find('.' + I)[0];
			this.elemPicker.find('.' + B).css('top', e),
				(n.style.background = '#' + r),
				this.elemPicker
					.find('.' + E)
					.css({ top: (o / n.offsetHeight) * 100 + '%', left: (i / n.offsetWidth) * 100 + '%' });
		}),
						...
						-1 < l.indexOf(',')
							? ((t = Y(F(l))),
								...
								3 < (l.match(/[0-9]{1,3}/g) || []).length &&
									...
									((r = 280 * l.slice(l.lastIndexOf(',') + 1, l.length - 1)),
									c.elemPicker.find('.' + D).css('left', r),
									(o = s[0].style.background = l)))
							: (3 === (r = -1 < (r = l).indexOf('#') ? r.substring(1) : r).length &&
									(r = (n = r.split(''))[0] + n[0] + n[1] + n[1] + n[2] + n[2]),
								(n = { r: (r = parseInt(r, 16)) >> 16, g: (65280 & r) >> 8, b: 255 & r }),
								(t = Y(n)),
								(s[0].style.background = o = '#' + j(t)),
								c.elemColorBox
									.find('.' + w)
		...
		s.on(i, function (e) {
			...
			n.thisId &&
				...
				k(e.target).hasClass(c) ||
					k(e.target).parents('.' + c)[0] ||
					k(e.target).hasClass(a.replace(/\./g, '')) ||
					k(e.target).parents(a)[0] ||
					(i.elemPicker &&
						(i.color
							? ((e = Y(F(i.color))), i.select(e.h, e.s, e.b))
							: i.elemColorBox
									.find('.' + w)
									.removeClass(x)
									.addClass(P),
	...
	var u = layui.$,
		...
		C = {
			tabClick: function (t) {
				...
				l ||
					n ||
					(a.addClass(r).siblings().removeClass(r), i.eq(t).addClass(h).siblings().removeClass(h)),
					layui.event.call(this, c, 'tab(' + s + ')', { elem: e, index: t });
			},
			...
			tabAuto: function (l) {
				...
				u('.layui-tab').each(function () {
					var t,
						...
						e =
							(i.children('.layui-tab-content').children('.layui-tab-item'), 'lay-stope="tabmore"'),
						e = u(
					...
					c === window && d.ie,
						i.attr('lay-allowclose') &&
							a.find('li').each(function () {
								...
								i.find('.' + o)[0] ||
									((t = u(
										'<i class="layui-icon layui-icon-close layui-unselect ' + o + '"></i>'
									)).on('click', C.tabDelete),
									i.append(t));
							}),
						'string' != typeof i.attr('lay-unauto') &&
							(a.prop('scrollWidth') > a.outerWidth() + 1 ||
							(a.find('li').length && a.height() > (t = a.find('li').eq(0).height()) + t / 2)
			...
			collapse: function () {
				...
				'string' == typeof e.attr('lay-accordion') &&
					((e = e.children('.layui-colla-item').children('.' + h))
								...
								u(y + a).each(function (t) {
									...
									i.find('.' + p)[0] ||
										...
										e.find('a').each(function () {
											...
											t.siblings('.' + v)[0] &&
												!t.children('.' + m)[0] &&
												t.append('<i class="layui-icon layui-icon-down ' + m + '"></i>'),
...
layui.define(['lay', 'layer'], function (e) {
	...
	var x = layui.$,
		...
		z = function (e) {
			var i = this;
			(i.index = ++s.index), (i.config = x.extend({}, i.config, s.config, e)), i.render();
		};
	(z.prototype.config = {
		accept: 'images',
		exts: '',
		...
		(z.prototype.render = function (e) {
			...
			return 1 < n.length
				? (layui.each(n, function () {
						s.render(x.extend({}, t, { elem: this }));
					}),
					i)
				: (x.extend(t, a.options(n[0], { attr: n.attr('lay-data') ? 'lay-data' : null })),
					!e && n[0] && n.data(c)
						? (e = o.getThis(n.data(c)))
							? e.reload(t)
							: void 0
						: ((t.elem = x(t.elem)),
		...
		(z.prototype.file = function () {
			var e = this,
				...
				n = i.elem.next();
			(n.hasClass(l) || n.hasClass(r)) && n.remove(),
				b.ie && b.ie < 10 && i.elem.wrap('<div class="layui-upload-wrap"></div>'),
				e.isFile() ? ((e.elemFile = i.elem), (i.field = i.elem[0].name)) : i.elem.after(t),
				b.ie && b.ie < 10 && e.initIE();
		}),
		(z.prototype.initIE = function () {
			var t,
				e = this.config,
				i = x(
			...
			x('#' + F)[0] || x('body').append(i),
				e.elem.next().hasClass(r) ||
					(this.elemFile.wrap(n),
					e.elem.next('.' + r).append(
						((t = []),
		...
		(z.prototype.msg = function (e) {
			return i.msg(e, { icon: 2, shift: 6 });
		}),
		(z.prototype.isFile = function () {
			var e = this.config.elem[0];
			if (e) return 'input' === e.tagName.toLocaleLowerCase() && 'file' === e.type;
		}),
		(z.prototype.preview = function (n) {
			window.FileReader &&
		...
		(z.prototype.upload = function (e, i) {
			var t,
				n,
				a,
				o,
					...
					u.elemFile.parent().submit(),
						...
						(z.timer = setInterval(function () {
							...
							try {
								...
								u.msg(c['cross-domain']), clearInterval(z.timer), m();
							}
							e && (clearInterval(z.timer), i.html(''), p(0, e));
						}, 30));
				},
				p = function (e, i) {
					if (
			...
			if (0 !== g.length) {
				switch (f.accept) {
					...
					case 'video':
						layui.each(g, function (e, i) {
							if (
								!RegExp('.\\.(' + (h || 'avi|mp4|wma|rmvb|rm|flash|3gp|flv') + ')$', 'i').test(
									escape(i)
								)
							)
								return (t = !0);
					...
					default:
						layui.each(g, function (e, i) {
							if (
								!RegExp('.\\.(' + (h || 'jpg|png|gif|bmp|jpeg|svg|webp') + ')$', 'i').test(
									escape(i)
								)
							)
								return (t = !0);
					...
					if (0 < f.size && !(b.ie && b.ie < 10))
						if (
							(layui.each(s(), function (e, i) {
								i.size > 1024 * f.size &&
									((i = 1 <= (i = f.size / 1024) ? i.toFixed(2) + 'MB' : f.size + 'KB'),
									(l.value = ''),
									(o = i));
							}),
							o)
			...
			var a = this,
				...
				l = function (e, i) {
					...
					t.next().hasClass(w) && t.next().remove(),
						...
						a.isFile() ||
							n.choose ||
							t.after('<span class="layui-inline ' + w + '">' + e + '</span>');
				},
				r = function (t) {
					var n = !0;
					return (
						layui.each(a.files, function (e, i) {
							if (!(n = !(i.name === t.name))) return !0;
						}),
						n
					);
				},
				u = function (e) {
					var t = function (e) {
						(e.ext = e.name.substr(e.name.lastIndexOf('.') + 1).toLowerCase()),
							(e.sizes = s.util.parseSize(e.size));
					};
					return (
			...
			n.elem.off('upload.start').on('upload.start', function () {
				...
				(b.ie && b.ie < 10) ||
					n.elem
						...
						.on('upload.drop', function (e, i) {
							var t = x(this),
								i = f(i.originalEvent.dataTransfer.files);
							t.removeAttr('lay-over'), o(i), n.auto ? a.upload() : l(i);
						}),
				a.elemFile.on('change', function () {
					var e = f(this.files);
					0 !== e.length && (o(e), n.auto ? a.upload() : l(e));
				}),
				...
				n.elem.data(c) ||
					(n.elem.on('click', function () {
						a.isFile() || x(this).trigger('upload.start');
					}),
					n.drag &&
						n.elem
		...
		(s.util = {
			parseSize: function (e, i) {
				var t, n;
				return (
					(i = i || 2),
					null != e && e
						? ((t = 'string' == typeof e ? parseFloat(e) : e),
							(n = Math.floor(Math.log(t) / Math.log(1024))),
							(e = (e = t / Math.pow(1024, n)) % 1 == 0 ? e : parseFloat(e.toFixed(i))) +
		...
		(o.getThis = function (e) {
			var i = o.that[e];
			return (
				i || hint.error(e ? t + " instance with ID '" + e + "' not found" : 'ID argument required'),
				i
			);
		}),
		(s.render = function (e) {
...
layui.define(['lay', 'layer', 'util'], function (e) {
		...
		i =
					...
					n = {
						input: function (e) {
								...
								t =
									...
									function (e, t) {
										var i = e.val(),
											...
											c = 'init' === t;
										isNaN(a) ||
											('click' === t && (a = !!T(this).index() ? a - n : a + n),
											(t = function (e) {
											...
											}).increment[r <= a && !o ? 'addClass' : 'removeClass'](A),
											n.decrement[a <= l && !o ? 'addClass' : 'removeClass'](A));
									});
							a.find('input[lay-affix],textarea[lay-affix]').each(function () {
								var r = T(this),
									...
									d = function (e, t) {
										(e = T(e))[0] && e[T.trim(t) ? 'removeClass' : 'addClass'](F);
									},
									n = function (i) {
										i = T.extend({}, f[s] || { value: s }, i, lay.options(r[0]));
										var a,
											t = T('<div class="' + u + '">'),
										...
										l[0]
											...
											e.on('click', function () {
												...
												T(this).hasClass(A) ||
													...
													layui.event.call(this, $, 'input-affix(' + e + ')', {
														elem: r[0],
														affix: s,
														options: i
													}));
						...
						select: function (e) {
							var m,
								u = '\u8bf7\u9009\u62e9',
								g = 'layui-form-select',
								b = 'layui-select-title',
								x = 'layui-select-none',
								k = 'layui-select-create-option',
								C = '',
								e = e || a.find('select'),
								w = function (e, t) {
									(T(e.target).parent().hasClass(b) && !t) ||
										((e = T('.' + g)).removeClass(g + 'ed ' + g + 'up'),
										e.hasClass('layui-select-creatable') &&
											e
												.children('dl')
												.children('.' + k)
												.remove(),
								...
								d = function (n, e, t, c) {
									...
									e ||
										...
										(i = function () {
											var e = n.offset().top + n.outerHeight() + 5 - j.scrollTop(),
												t = y.outerHeight(),
												i = y.children('dd');
											(v = r[0].selectedIndex),
												n.addClass(g + 'ed'),
												...
												(s = null),
												i.removeClass(_),
												0 <= v && i.eq(v).addClass(_),
												e + t > j.height() && t <= e && n.addClass(g + 'up'),
												d(),
												a &&
													y.off('mousedown.select.ieph').on('mousedown.select.ieph', function () {
														(h[0].__ieph = !0),
															setTimeout(function () {
																h[0].__ieph = !1;
															}, 60);
										...
										(o = function (e) {
											n.removeClass(g + 'ed ' + g + 'up'),
												h.blur(),
												(s = null),
												c && y.children('.' + k).remove(),
												e ||
													l(h.val(), function (e) {
														var t = r[0].selectedIndex;
														e &&
															((C = T(r[0].options[t]).html()),
															0 === t && C === h.attr('placeholder') && (C = ''),
															h.val(C || ''));
													});
										}),
										(d = function () {
											...
											i[0] &&
												...
												(t = y.height()),
												(i = i.height()),
												t < e && y.scrollTop(e + y.scrollTop() - t + i - 5),
												e < 0) &&
												y.scrollTop(e + y.scrollTop() - 5);
										}),
										f.on('click', function (e) {
											(n.hasClass(g + 'ed') ? o : (w(e, !0), i))(), y.find('.' + x).remove();
										}),
										f.find('.layui-edge').on('click', function () {
											h.focus();
										}),
										h
											.on('keyup', function (e) {
												...
												var e = l.keyCode,
													r =
														...
														function (a, n) {
															l.preventDefault();
															var e = (function () {
																	var e = y.children('dd.' + _);
																	if (y.children('dd.' + F)[0] && 'next' === a) {
																		var t = y.children('dd:not(.' + F + ',.' + A + ')'),
																			i = t.eq(0).index();
																		if (0 <= i && i < e.index() && !t.hasClass(_))
															...
															return t[0]
																? ((s = e[a]()),
																	(i[0] && !i.hasClass(A)) || !s[0]
																		? (i.addClass(_).siblings().removeClass(_), void d())
																		: r(a, s))
																: (s = null);
														});
												38 === e && r('prev'),
													40 === e && r('next'),
													13 === e && (l.preventDefault(), y.children('dd.' + _).trigger('click'));
											})
											.on('paste', function () {
												i();
											}),
												...
												t =
													(layui.each(t, function () {
														var e = T(this),
															...
															a =
																(c && !i && t === o && (s = !0),
																'cs' !== u && ((t = t.toLowerCase()), (n = n.toLowerCase())),
																-1 === t.indexOf(n));
														('' === n || 'blur' === l ? n !== t : a) && r++,
															'keyup' === l && e[(c ? a && !i : a) ? 'addClass' : 'removeClass'](F);
													}),
													'keyup' === l &&
														layui.each(p, function () {
															...
															e[
																(t = c ? t.not('.' + k) : t).length == t.filter('.' + F).length
																	? 'addClass'
																	: 'removeClass'
															](F);
														}),
														...
														return (
															...
															(a && e.target.__ieph
																...
																: (l(
																		...
																		function (e, t) {
																			c
																				? t
																					? y.children('.' + k).remove()
																					: (t = y.children('.' + k))[0]
																						? t.attr('lay-value', i).html(N.escape(i))
																						: ((t = T('<dd>'))
																								.addClass(k)
																								.attr('lay-value', i)
																								.html(N.escape(i)),
																	...
																	'' === i &&
																		(r.val(''),
																		y.find('.' + _).removeClass(_),
																		(r[0].options[0] || {}).value ||
																			y.children('dd:eq(0)').addClass(_),
																		y.find('.' + x).remove(),
																		c) &&
																		y.children('.' + k).remove(),
																	void d()))
											...
											return (
												t.hasClass(A) ||
													(t.hasClass('layui-select-tips')
														? h.val('')
														: (h.val(t.text()), t.addClass(_)),
													c &&
														t.hasClass(k) &&
														(t.removeClass(k),
														(e = T('<option>')).attr('value', i).text(t.text()),
														r.append(e)),
													t.siblings().removeClass(_),
													r.val(i).removeClass('layui-form-danger'),
													layui.event.call(this, $, 'select(' + a + ')', {
														elem: r[0],
														value: i,
														othis: n
													}),
										...
										T(document).off('click', w).on('click', w));
								};
							e.each(function (e, t) {
								var i = T(this),
									a = i.next('.' + g),
								...
								var s,
									...
									r = T(
										[
											'<div class="' + (o ? '' : 'layui-unselect ') + g,
											n ? ' layui-select-disabled' : '',
											(c ? ' layui-select-creatable' : '') + '">',
											'<div class="' + b + '">',
											...
											0 === s.length &&
												s.push('<dd lay-value="" class="' + A + '">\u6ca1\u6709\u9009\u9879</dd>'),
											s.join('') + '</dl>'),
											'</div>'
										].join('')
									);
						...
						checkbox: function (e) {
							...
							e.each(function (e, t) {
								var i = T(this),
									...
									n = N.escape(T.trim(t.title || (t.title = i.attr('lay-text') || ''))),
									l = this.disabled,
									r = c[a] || c.checkbox,
									s = i.next('.' + r[0]),
									o = (s[0] && s.remove(), []);
									...
									function (a) {
										...
										a.on('click', function () {
											...
											n[0].disabled ||
												...
												(n[0].checked = !0),
												a.addClass(o + 'ed'),
												a.children('.layui-icon').addClass(l + ' ' + c[0]),
												layui.event.call(n[0], $, 'radio(' + i + ')', {
													elem: n[0],
													value: n[0].value,
													othis: a
												}));
			...
			(t.prototype.submit = function (e, t) {
				var i = {},
					...
					n = this.getFormElem ? this.getFormElem(e) : a.parents(u).eq(0),
					l = n.find('*[lay-verify]');
				return (
					!!r.validate(l) &&
					((i = r.getValue(null, n)),
	...
	T(function () {
		...
		t.on('reset', u, function () {
			var e = T(this).attr('lay-filter');
			setTimeout(function () {
				r.render(null, e);
			}, 50);
		}),
		t.on('submit', u, i).on('click', '*[lay-submit]', i),
		e($, r);
});
	...
	var f = layui.$,
		...
		c =
			...
			(i.prototype.render = function (e) {
				...
				(a.index = t.index),
					...
					a.height && /^full-.+$/.test(a.height)
						? ((t.fullHeightGap = a.height.split('-')[1]),
							(a.height = r.height() - (parseFloat(t.fullHeightGap) || 0)))
				...
				n
					.addClass(
						((l = [L, L + '-' + t.index, 'layui-form', 'layui-border-box']),
					...
					.html(m(s, { open: '{{', close: '}}' }).render({ data: a, index: t.index })),
					t.renderStyle(),
			...
			(i.prototype.setGroupWidth = function (i) {
				...
				l.config.cols.length <= 1 ||
					((e = l.layHeader.find(
						(i ? 'th[data-key=' + i.data('parentkey') + ']>' : '') + '.' + I
					)).css('width', 0),
			...
			(i.prototype.setColsWidth = function () {
					...
					e =
						...
						function (o) {
							layui.each(r.cols, function (e, n) {
								layui.each(n, function (e, t) {
									var a = 0,
										i = t.minWidth || r.cellMinWidth,
										l = t.maxWidth || r.cellMaxWidth;
									t
										? t.colGroup ||
											t.hide ||
											(o
				...
				0 < n.autoColNums &&
					...
					((e = (a = (t = function (e) {
						return !(e =
							e || n.layHeader.eq(0).find('thead > tr:first-child > th:last-child')).data(
							'field'
						) && e.prev()[0]
							? t(e.prev())
							: e;
				...
				var e,
					...
					d = function () {
						'object' == typeof n.initSort &&
							l.sort({ field: n.initSort.field, type: n.initSort.type, reloadType: t.type });
					},
					c = function (e, t) {
						l.setColsWidth(),
							l.loading(!1),
							'function' == typeof n.done && n.done(e, a, e[r.countName], t);
					};
				(t = t || {}),
					'function' == typeof n.before && n.before(n),
					(l.startTime = new Date().getTime()),
					t.renderData
						? (((e = {})[r.dataName] = k.cache[l.key]),
							(e[r.countName] = n.url
								? 'object' === layui.type(n.page)
									? n.page.count
									: e[r.dataName].length
								: n.data.length),
							'object' == typeof n.totalRow && (e[r.totalRowName] = f.extend({}, l.totalRow)),
						...
						: n.url
							? ((i = {}),
								...
								f.ajax({
									...
									success: function (e) {
										(e = 'function' == typeof n.parseData ? n.parseData(e) || e : e)[
											r.statusName
										] != r.statusCode
											? l.errorView(
													e[r.msgName] ||
							...
							: 'array' === layui.type(n.data) &&
								((e = {}),
								(i = a * n.limit - n.limit),
								(o = n.data.concat()),
								(e[r.dataName] = n.page ? o.splice(i, n.limit) : o),
								(e[r.countName] = n.data.length),
								'object' == typeof n.totalRow && (e[r.totalRowName] = f.extend({}, n.totalRow)),
								(l.totalRow = e[r.totalRowName]),
								l.renderData({ res: e, curr: a, count: e[r.countName], type: t.type }),
								d(),
								c(e, t.type));
									...
									l.colGroup ||
										((e = [
											'<td data-field="' +
												...
												e.join(' ')) +
												' class="' +
												((t = []), l.hide && t.push(D), l.field || t.push(H), t.join(' ')) +
												'">',
											'<div class="layui-table-cell laytable-cell-' +
										...
										i.push(e),
										l.fixed && 'right' !== l.fixed && r.push(e),
										'right' === l.fixed && d.push(e));
							}),
							(e = ['data-index="' + e + '"']),
			...
			(i.prototype.renderData = function (e) {
				...
				return (
					(k.cache[a.key] = r),
					a.layTotal[0 == r.length ? 'addClass' : 'removeClass'](y),
					a.layPage[i.page || i.pagebar ? 'removeClass' : 'addClass'](D),
					a.layPage
						.find(P)
						[!i.page || 0 == n || (0 === r.length && 1 == l) ? 'addClass' : 'removeClass'](y),
					0 === r.length
						? a.errorView(i.text.none)
						: (a.layFixLeft.removeClass(D),
							o
								? u()
								: (u(),
									a.renderTotal(r, t),
									a.layTotal && a.layTotal.removeClass(D),
									void (
										i.page &&
										((i.page = f.extend(
											{
			...
			(i.prototype.renderTotal = function (e, o) {
				...
				c.totalRow &&
					...
					d.eachCols(function (e, t) {
						var a,
							...
							l =
								((a = t.totalRowText || ''),
								((n = { LAY_COL: t })[e] = l),
								(n = (t.totalRow && T.call(d, { item3: t, content: l, tplData: n })) || a),
								i || n),
							n =
								(t.field &&
									d.dataTotal.push({ field: t.field, total: f('<div>' + l + '</div>').text() }),
								[
									'<td data-field="' +
										e +
										'" data-key="' +
										...
										a.join(' ')) +
										' class="' +
										((n = []), t.hide && n.push(D), t.field || n.push(H), n.join(' ')) +
										'">',
									'<div class="layui-table-cell laytable-cell-' +
										...
										('string' == typeof (a = t.totalRow || c.totalRow)
											? m(a).render(
													f.extend({ TOTAL_NUMS: i || s[e], TOTAL_ROW: o || {}, LAY_COL: t }, t)
												)
											: l),
									'</div></td>'
								].join(''));
					...
					d.layTotal
						.find('tbody')
						.html('<tr>' + r.join('') + (e.length ? e.get(0).outerHTML : '') + '</tr>'));
			}),
			...
			(i.prototype.setRowChecked = function (i) {
				var e = this,
					...
					t = ((i = f.extend({ type: 'checkbox' }, i)), k.cache[e.key]),
					a = 'checked' in i,
					d = function (e) {
					...
					t =
						(layui.each(t, function (e, t) {
							...
							'array' === layui.type(t) ||
								t[l.disabledName] ||
								(n || (o ? -1 !== i.index.indexOf(e) : Number(i.index) === e)
									? ((a = t[l.checkName] = d(t[l.checkName])),
										(e = r.filter('[data-index="' + e + '"]'))[a ? 'addClass' : 'removeClass'](_),
										'radio' === i.type && e.siblings().removeClass(_))
									: 'radio' === i.type && delete t[l.checkName]);
						}),
						r.find(
							'input[lay-type="' +
					...
					c = t.last(),
					s = c.closest(u);
				('radio' === i.type && s.hasClass(D) ? t.first() : t).prop('checked', d(c.prop('checked'))),
					e.syncCheckAll(),
					e.renderForm(i.type);
			}),
			(i.prototype.sort = function (l) {
				...
				try {
					...
					var c = t.layHeader.find('th .laytable-cell-' + d).find(A);
					t.layHeader.find('th').find(A).removeAttr('lay-sort'),
						c.attr('lay-sort', l.type || null),
						t.layFixed.find('th');
				} catch (s) {
					b.error("Table modules: sort field '" + r + "' not matched");
				}
					...
					(a = t.index),
						...
						d.eachCols(function (e, t) {
							...
							(i in l || (('function' == typeof n ? n(i, e) : n) && (t.templet || t.toolbar))) &&
								...
								(a = o[t.field]),
								i.html(T.call(d, { item3: t, content: a, tplData: f.extend({ LAY_COL: t }, o) })),
								e.data('content', a),
				...
				var c = this,
					...
					d =
						(c.layTool.on('click', '*[lay-event]', function (e) {
							...
							switch (
								(layui.stope(e), z.trigger('table.tool.panel.remove'), p.close(c.tipsIndex), t)
							) {
								case 'LAYTABLE_COLS':
									n({
										list:
											...
											v.on('checkbox(LAY_TABLE_TOOL_COLS)', function (e) {
												...
												i.key &&
													((i.hide = !t),
													c.elem.find('*[data-key="' + a + '"]')[t ? 'removeClass' : 'addClass'](D),
								...
								case 'LAYTABLE_EXPORT':
									if (!l.length)
										return p.tips('\u5f53\u524d\u8868\u683c\u65e0\u6570\u636e', this, { tips: 3 });
									x.ie
										? p.tips(
								...
								case 'LAYTABLE_PRINT':
									...
									var o = window.open('about:blank', '_blank'),
										...
										d = f(c.layHeader.html());
									d.append(c.layMain.find('table').html()),
										d.append(c.layTotal.find('table').html()),
										...
										d
											...
											.remove(),
										d.find('tbody>tr>td.' + H).remove(),
										o.document.write(r + d.prop('outerHTML')),
										o.document.close(),
						...
						e
							...
							.on('mouseleave', function () {
								f(this);
								w.eventMoveElem || ((r.allowResize = !1), o.css('cursor', ''));
							})
							.on('mousedown', function (e) {
								var t,
									a = f(this);
							...
							z
								.on('mousemove', function (e) {
									...
									w.eventMoveElem &&
										...
										(a = w.eventMoveElem.closest('.' + L).attr(R)),
										(a = C(a))) &&
								...
								.on('mouseup', function (e) {
									var t, a, i, l, n;
									w.eventMoveElem &&
										((i = (t = w.eventMoveElem).closest('.' + L).attr(R)), (a = C(i))) &&
										((i = t.data('key')),
										(l = a.col(i)),
					...
					a =
						(c.elem.on('click', 'input[name="layTableCheckbox"]+', function (e) {
							...
							t[0].disabled ||
								(n
									...
									: (c.setRowChecked({ index: i, checked: l }), layui.stope(e)),
								layui.event.call(
									t[0],
									N,
									'checkbox(' + u + ')',
						...
						c.layBody
							.on('mouseenter', 'tr', function () {
								var e = f(this),
									t = e.index();
								e.data('off') || c.layBody.find('tr:eq(' + t + ')').addClass(W);
							})
							.on('mouseleave', 'tr', function () {
								var e = f(this),
									t = e.index();
								e.data('off') || c.layBody.find('tr:eq(' + t + ')').removeClass(W);
							})
						...
						function (e) {
							var t = f(this);
							t.data('off') ||
								layui.event.call(this, N, e + '(' + u + ')', d.call(t.children('td')[0]));
						}),
					n = function (e, t) {
						var a, i, l;
						(e = f(e)).data('off') ||
					...
					l = function (e, t) {
						var a = f(this),
							...
							d = f('<i class="layui-icon layui-icon-up ' + i + '">');
				...
				c.layBody
					...
					c.layMain.on('scroll', function () {
						...
						c.layHeader.scrollLeft(t),
							...
							c.layFixed.find(E).scrollTop(e),
							p.close(c.tipsIndex);
					}),
					c.layFixed.find(E).on('mousewheel DOMMouseScroll', function (e) {
						var t = e.originalEvent.wheelDelta || -e.originalEvent.detail,
					...
					e.each(function () {
						var l,
							...
							t = d.options(this, {
								...
								errorText: r + (t || e.attr('lay-options'))
							}),
							n = f.extend(
								{
									elem: this,
											...
											.each(function (e) {
												var t = f(this),
													...
													a = d.options(this, {
														...
														errorText: r + (a || t.attr('lay-options'))
													}),
													t = f.extend(
														{
															title: t.text(),
									...
									!1 === t.ignoreExport || (t.field && 'normal' == t.type)
										? (t.hide && !1 !== t.ignoreExport) || !0 === t.ignoreExport
											...
											: (((a = l[t.field]) !== undefined && null !== a) || (a = ''),
												...
												n.push((a = '"' + a + '"')))
										: t.field && 'normal' !== t.type && 0 == i && (d[t.field] = !0);
								}),
							r.push(n.join(','));
					}),
					c &&
						layui.each(c.dataTotal, function (e, t) {
							d[t.field] || i.push('"' + (t.total || '') + '"');
						}),
					o.join(',') + '\r\n' + r.join('\r\n') + '\r\n' + i.join(','))
				)),
			...
			n &&
				('boolean' === layui.type(l)
					? n.eachCols(function (e, t) {
							...
							i.hide != l &&
								((i = i.hide = l),
								n.elem.find('*[data-key="' + a + '"]')[i ? 'addClass' : 'removeClass'](D),
								n.setParentCol(i, t));
						})
...
layui.define(['table'], function (e) {
	...
	var A = layui.$,
		...
		g = function (n, i, e) {
			...
			layui.each(e || l, function (e, t) {
				var a = t[z] || '';
				-1 !== a.indexOf('-') && (l[a] = t), t[i] && g(n, i, t[i]);
			});
		},
		d = function (d, a, e) {
			var r = j(d),
	...
	(a.prototype.initData = function (e, t) {
		var a = this.getOptions(),
			...
			d = function (e, a) {
				layui.each(e, function (e, t) {
					i in t || (t[i] = !(!t[l] || !t[l].length)), (t[m] = t[z]), (t[f] = a = a || '');
					e = t[z] = (a ? a + '-' : '') + e;
					d(t[l] || [], e);
				});
			};
		...
		v =
			...
			(a.prototype.renderTreeTable = function (e, t, a) {
				var l = this,
					n = l.getOptions(),
					d = n.elem.next(),
					i = (d.hasClass(h) || d.addClass(h), n.id),
					r = n.tree || {},
					o = (r.data, r.view || {}),
					c = r.customName || {},
					u = c.isParent,
					...
					(layui.each(e.find('td[data-field="' + y + '"]'), function (e, t) {
						...
						t.hasClass('layui-table-tree-item') ||
							((n = i.attr('lay-data-index')) &&
								...
								(n = t.html()),
								(t = i.find('td[data-field="' + y + '"]>div.layui-table-cell')).addClass(
		...
		u =
			...
			(B.removeNode = function (e, t) {
				...
				if (a) {
					var n,
						i = a.getOptions(),
						l = i.tree,
						d = l.customName.isParent,
						r = l.customName.children,
						o = i.elem.next(),
						c = [],
						u = P.cache[e],
						t = a.getNodeDataByIndex('string' === layui.type(t) ? t : t[z], !1, 'delete'),
						s = a.getNodeDataByIndex(t[f]),
						l = (a.updateCheckStatus(s), a.treeToFlat([t], t[l.customName.pid], t[f])),
						t =
							(layui.each(l, function (e, t) {
								t = t[z];
								c.push('tr[lay-data-index="' + t + '"]'), -1 !== t.indexOf('-') && delete u[t];
							}),
							o.find(c.join(',')).remove(),
							a.initData());
					for (n in u) -1 !== n.indexOf('-') && n !== u[n][z] && delete u[n];
					layui.each(a.treeToFlat(t), function (e, t) {
						t[m] &&
							t[m] !== t[z] &&
							o
						...
						layui.each(u, function (e, t) {
							o.find('tr[data-level="0"][lay-data-index="' + t[z] + '"]')
								.attr('data-index', e)
								.data('index', e);
						}),
						i.hasNumberCol && v(a),
						s &&
							((l = o.find('tr[lay-data-index="' + s[z] + '"]')),
							(s[d] = !(!s[r] || !s[r].length)),
							a.updateNodeIcon({ scopeEl: l, isExpand: s[H], isParent: s[d] })),
						B.resize(e);
				}
			}),
			...
			(a.prototype.updateParentCheckStatus = function (a, n) {
				...
				return (
					...
					(a[l] = n),
					d.push(A.extend({}, a)),
					(d = a[f] ? d.concat(this.updateParentCheckStatus(P.cache[e][a[f]], n)) : d)
				);
			}),
			function (e, t, a) {
				var n = this,
			...
			e.elem.data('haveEvents') ||
				...
				l.touchSwipe(t, {
					onTouchEnd: function (e, i) {
						...
						(0.25 < Math.abs(i / n) || Math.abs(i) > t[a ? 'height' : 'width']() / 3) &&
							o.slide(0 < i ? '' : 'sub');
					}
				}),
	...
	(l.prototype.load = function (o) {
		...
		if (g[0])
			return (
				...
				g.find('.layui-flow-more')[0] || g[f ? 'prepend' : 'append'](p),
				(t = function (o, l) {
				...
				(d = function () {
					(i = !0),
						...
						'function' == typeof o.done && o.done(++h, t);
				})(),
		...
		(l.prototype.lazyimg = function (o) {
			var l,
				...
				r = function (o, l) {
					var e = (u ? l || f : v(window)).height(),
						t = f.scrollTop(),
						i = t + e;
					if (((m.lazyimg.elem = v(s)), o)) p(o, e);
					else
					...
					'reloadCode' === e
						...
						: ((d = layui.code.index = ++W),
							...
							l.preview &&
								...
								(_ = x(
									'<div class="' +
										[A.ELEM_ITEM, A.ELEM_ITEM + '-preview', 'layui-border'].join(' ') +
										'">'
								)),
