...
>
	...
	{#if cardData}
		<div class="mb-3">
			<div class="font-medium text-gray-900 dark:text-white mb-2">任务执行结果</div>
		...
		<div class="flex space-x-2">
			<Button variant="primary" size="sm" on:click={handleViewDetails}>查看详情</Button>
			<Button variant="secondary" size="sm" on:click={handleRestart}>重新执行</Button>
		</div>
	{/if}
</div>
