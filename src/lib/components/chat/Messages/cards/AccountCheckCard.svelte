...
>
	...
	{#if cardData}
		<div class="mb-3">
			<div class="font-medium text-gray-900 dark:text-white mb-2">账号状态</div>
			...
			{:else}
				<div class="text-center py-4 text-gray-500 dark:text-gray-400">未配置任何账号</div>
			{/if}
		</div>

		<div class="flex space-x-2">
			<Button variant="primary" size="sm" on:click={handleAuthorize}>授权账号</Button>
			<Button variant="secondary" size="sm" on:click={handleRecheck}>重新检查</Button>
		</div>
	{/if}
</div>
