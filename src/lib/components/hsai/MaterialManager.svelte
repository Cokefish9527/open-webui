...
<div class="hsai-material-manager h-full flex">
  ...
  <div class="folder-tree w-1/4 border-r border-gray-200 dark:border-gray-600 p-4">
    ...
    <div class="folder-list space-y-2">
      <!-- 根文件夹 -->
      <div
        class="folder-item cursor-pointer p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 {currentSelectedFolder === null ? 'bg-blue-100 dark:bg-blue-900' : ''}"
      ...
      {#each currentFolders as folder}
        <div
          class="folder-item cursor-pointer p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 {currentSelectedFolder?.id === folder.id ? 'bg-blue-100 dark:bg-blue-900' : ''}"
  ...
  <div class="material-list flex-1 p-4">
    ...
    {:else}
      <!-- 素材网格 -->
      <div class="material-grid grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
        {#each currentMaterials as material}
          <div class="material-card border rounded-lg p-3 hover:shadow-md transition-shadow">
            <!-- 缩略图或图标 -->
            <div class="material-preview h-24 bg-gray-100 dark:bg-gray-700 rounded flex items-center justify-center mb-2">
