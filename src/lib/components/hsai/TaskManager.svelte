<script lang="ts">
  ...
  function getStatusInfo(status: string) {
    return (statusMap as Record<string, any>)[status] || { label: status, color: 'bg-gray-100 text-gray-800' };
  }
          ...
          <div class="flex items-start justify-between">
            ...
            <div class="flex-1">
              ...
              {#if task.error_message}
                <div class="mt-2 p-2 bg-red-50 dark:bg-red-900 text-red-600 dark:text-red-400 rounded text-sm">
