# Python 3.13 虚拟环境设置脚本
# 该脚本将创建并设置 Python 3.13 虚拟环境

Write-Host "=== Python 3.13 虚拟环境设置脚本 ===" -ForegroundColor Green

# 设置 Python 3.13 路径
$python313Path = "C:\Users\bmkz\AppData\Local\Programs\Python\Python313"
$pythonExe = "$python313Path\python.exe"

# 检查 Python 3.13 是否存在
if (-not (Test-Path $pythonExe)) {
    Write-Host "错误: 未找到 Python 3.13: $pythonExe" -ForegroundColor Red
    exit 1
}
...
if ($LASTEXITCODE -ne 0) {
    Write-Host "错误: 无法运行 Python 3.13" -ForegroundColor Red
    exit 1
}
